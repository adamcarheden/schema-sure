...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _getPrototypeOf = __webpack_require__(1);var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);var _classCallCheck2 = __webpack_require__(27);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _possibleConstructorReturn2 = __webpack_require__(28);var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);var _inherits2 = __webpack_require__(75);var _inherits3 = _interopRequireDefault(_inherits2);var _preventExtensions = __webpack_require__(83);var _preventExtensions2 = _interopRequireDefault(_preventExtensions);var _create = __webpack_require__(80);var _create2 = _interopRequireDefault(_create);var _freeze = __webpack_require__(86);var _freeze2 = _interopRequireDefault(_freeze);var _keys = __webpack_require__(89);var _keys2 = _interopRequireDefault(_keys);var _typeof2 = __webpack_require__(29);var _typeof3 = _interopRequireDefault(_typeof2);var _merge = __webpack_require__(92);var _merge2 = _interopRequireDefault(_merge);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
				...
				switch (typeof v === 'undefined' ? 'undefined' : (0, _typeof3.default)(v)) {
					case 'string':
						...
						if (!('value' in _this3.template[v])) {
							if (typeof _this3.template[v].value !== 'function') throw new Error('You requested that we call \'' + v + '\' on property \'' + prop + '\', but \'' + v + '\' is property managed by DataTrue. We don\'t suppor that. Perhapse you wanted to set a static value for \'' + prop + '\' by setting the \'value\' key for that property in your object template instead.');
						} else {
							if (typeof _this3.template[v].value !== 'function') throw new Error('You requested that we call \'' + v + '\' on property \'' + prop + '\', but \'' + v + '\' is a \'' + (0, _typeof3.default)(_this3.template[v]) + '\', not a function');
						}
						return {
	...
	AtomicSetError = function (_Error) {(0, _inherits3.default)(AtomicSetError, _Error);
		function AtomicSetError(exceptions) {(0, _classCallCheck3.default)(this, AtomicSetError);
			...
			_this5.exceptions = exceptions;return (0, _possibleConstructorReturn3.default)(_this5);
