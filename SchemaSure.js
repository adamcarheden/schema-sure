	...
	SchemaSureClass = function () {
		function SchemaSureClass(clName, template, schemaSure, proto) {var _this6 = this;(0, _classCallCheck3.default)(this, SchemaSureClass);
			...
			(0, _keys2.default)(template).forEach(function (prop) {
				switch ((0, _typeof3.default)(template[prop])) {
					case 'object':
						break;
					case 'function':
						...
						break;
					default:
						throw new Error('I\'m not sure what to do with property \'' + prop + '\' of type \'' + (0, _typeof3.default)(template[prop]) + '\'. SchemaSure templates should be objects who\'s members are all either property definition objects or functions');}
